...
const Contact = (props) => {
  ...
  const whatsappEtnia1 = `https://api.whatsapp.com/send?phone=13054188434`;
    ...
    <>
      ...
      <main className={montserrat.className}>
        <section className={styles.aboutContainer}>
          <article className={styles.aboutContainer__infoEtnia} id="etniaInfo">
            <div>
          ...
          <section className={styles.aboutContainer__title}>
            <h1>/ SALES REPRESENTATIVES BY REGION IN USA /</h1>
          </section>
          <section className={styles.aboutContainer__map}>
            {isModalOpen && (
              <div className={styles.modal}>
                <>
                  <h1>info@etniapro.com</h1>
                  <br />
                  <p>Ph: 305 418 8434</p>
            ...
            >
              ...
              <a href="#" onClick={openModal}>
                <path
                  id="MN"
                  d="m558.547 73.847 1.941 6.892 4.077 24.848 1.941 9.9.583 8.736 2.232 5.242.485 4.464.389 1.456-.097.292-3.883 6.406 2.524 4.27 4.853 34.167.194 4.465 4.853-.292 19.122-1.067 47.755-3.98 4.756-.485v-.485l-1.36-7.474-5.92-3.01-4.659-4.852-7.377-4.465-2.33-.194-3.59-2.718.97-13.395-3.397-3.106 1.164-5.436 6.213-5.63-1.068-11.647 2.232-2.523 7.571-7.96 8.639-11.065 3.3-2.33 5.824-2.814 6.115-4.562-4.077.776-2.426-1.844-9.319 1.262-1.455-1.747-8.348 3.397-6.697-2.815-1.844-2.232-5.339.388-3.591-1.844 1.164-1.359-4.561-1.456h-4.077l-6.503 2.815-1.262-1.941-10.289-1.456-3.494-8.736-.388-2.62-4.465-1.263.388 7.474-11.842.874-14.656.582-.97.097z"
                  data-id="MN"
                  data-name="Minnesota"
                  style={{
                    strokeWidth: 0.97063118,
              ...
              >
                ...
                />
                <MdLocationOn x="380" y="80" color="#000000" />
                <text
              ...
              <a href="#etniaInfo">
                <path
                  id="ND"
                  d="m556.509 73.847-29.313.583-20.48-.097-17.569-.389-20.577-.776-1.068-.097-.097 3.882-1.262 23.684-1.553 30.478-.194 3.882 3.785.194 42.805 1.165 39.505-.291 16.404-.486 3.3-.194-.389-1.456-.485-4.464-2.232-5.242-.583-8.736-1.941-9.9-4.077-24.848-1.94-6.892h-2.04z"
                  data-id="ND"
              ...
              <a title="Hawaii" href="http://lvxmarketing.com/" target="_blank">
                ...
                />
                <MdLocationOn x="370" y="495" color="#000000" />
                <text
                  className={styles.text}
                  x="360"
                  y="520"
              ...
              >
                ...
                />
                <MdLocationOn x="295" y="140" color="#000000" />
                <text
                  className={styles.text}
                  x="295"
                  y="170"
              ...
              >
                ...
                />
                <MdLocationOn x="240" y="60" color="#000000" />
                <text
                  className={styles.text}
                  x="210"
                  y="90"
              ...
              >
                ...
                />
                <MdLocationOn x="320" y="335" color="#000000" />
                <text
                  className={styles.text}
                  x="300"
                  y="360"
              ...
              >
                ...
                />
                <MdLocationOn x="190" y="265" color="#000000" />
                <text
                  className={styles.text}
                  x="180"
                  y="300"
              ...
              >
                <path
                  id="CO"
                  d="m489.632 255.55.389-19.025-4.66-.194-23.683-.874-2.33-.097-1.94-.097-28.828-1.844-19.219-1.553-23.974-2.33-2.33-.29-.291 2.523-5.242 50.57-1.844 17.665-.776 7.668-.194 2.524 3.009.291 48.92 4.27 21.547 1.36 21.451.97 3.106.098 1.942.097 4.076.097 1.941.097 6.115.194h1.553v-1.941l1.068-51.347.097-5.726v-1.845l.097-1.261z"
                  data-id="CO"
                  data-name="Colorado"
                  style={{
                    strokeWidth: 0.97063118,
                ...
                />
                <MdLocationOn x="430" y="255" color="#000000" />
                <text
                  className={styles.text}
                  x="410"
                  y="285"
              ...
              <a title="Nevada" href="http://lvxmarketing.com/" target="_blank">
                <path
                  id="NV"
                ...
                />
                <MdLocationOn x="255" y="225" color="#000000" />
                <text
                  className={styles.text}
                  x="240"
                  y="255"
              ...
              >
                <path
                  id="NM"
                  d="m472.452 324.756.097-2.524.097-2.524.097-2.523-3.106-.098-21.45-.97-21.549-1.359-48.92-4.27-3.008-.292-.389 3.494-7.28 75.127-.679 7.086-2.718 28.633.389.097 13.394 1.262 1.262-6.794 2.427-1.941 27.178 2.426h.194l-2.427-4.756 12.327.874 30.77 1.747 19.218.873 3.3-91.045.68.097.096-2.62z"
                  data-id="NM"
                ...
                />
                <MdLocationOn x="410" y="345" color="#000000" />
                <text
                  className={styles.text}
                  x="385"
                  y="375"
              ...
              >
                ...
                />
                <MdLocationOn x="220" y="120" color="#000000" />
                <text
                  className={styles.text}
                  x="200"
                  y="150"
              ...
              <a title="Utah" href="http://lvxmarketing.com/" target="_blank">
                <path
                  id="UT"
                  d="m352.385 204.98-25.042-3.786-13.977-2.232-2.718-.486-.582 3.106-5.145 31.449-10.094 62.8-.486 3.106 2.524.388 25.042 3.98 17.569 2.523 32.71 4.077 2.524.291.194-2.524.776-7.668 1.844-17.665 5.242-50.57.291-2.524-1.941-.194-24.751-3.009-3.786-.485 2.427-18.927.194-1.262-2.815-.388z"
                  data-id="UT"
                  data-name="Utah"
                  style={{
                    strokeWidth: 0.97063118,
                ...
                />
                <MdLocationOn x="325" y="245" color="#000000" />
                <text
                  className={styles.text}
                  x="320"
                  y="275"
              ...
              >
                ...
                />
                <MdLocationOn x="405" y="170" color="#000000" />
                <text
                  className={styles.text}
                  x="385"
                  y="200"
              ...
              >
                ...
                />
                <MdLocationOn x="640" y="335" color="#000000" />
                <text
                  className={styles.text}
                  x="620"
                  y="365"
              ...
              <a title="Iowa" href="" target="_blank">
                <path
                  id="IA"
                ...
                />
                <MdLocationOn x="610" y="190" color="#000000" />
                <text
                  className={styles.text}
                  x="605"
                  y="220"
              ...
              <a title="Kansas" href="" target="_blank">
                <path
                  id="KS"
                  d="m608.923 312.72-2.427-41.058-4.368-2.524-.388-1.94-3.494-3.107 3.397-4.174-1.359-2.426-2.523.097-2.33-1.65-.97-.777-3.3.194-35.817 1.36-16.404.388h-32.613l-13.103-.195-3.689-.097v1.845l-.097 5.726-1.068 51.347v1.94l4.174.098 22.519.291 52.705-.776 37.563-1.747 3.689-.292-.097-2.523z"
                  data-id="KS"
                  data-name="Kansas"
                  style={{
                    strokeWidth: 0.97063118,
                ...
                />
                <MdLocationOn x="530" y="270" color="#000000" />
                <text
                  className={styles.text}
                  x="520"
                  y="300"
              ...
              <a title="Missouri" href="" target="_blank">
                <path
                  id="MO"
                ...
                />
                <MdLocationOn x="630" y="265" color="#000000" />
                <text
                  className={styles.text}
                  x="615"
                  y="295"
              ...
              <a title="Nebraska" href="" target="_blank">
                <path
                  id="NE"
                ...
                />
                <MdLocationOn x="520" y="210" color="#000000" />
                <text
                  className={styles.text}
                  x="500"
                  y="237"
              ...
              >
                ...
                />
                <MdLocationOn x="560" y="330" color="#000000" />
                <text
                  className={styles.text}
                  x="540"
                  y="360"
              ...
              >
                ...
                />
                <MdLocationOn x="645" y="420" color="#000000" />
                <text
                  className={styles.text}
                  x="635"
                  y="450"
              ...
              <a title="Texas" href="http://lvxmarketing.com/" target="_blank">
                ...
                />
                <MdLocationOn x="520" y="400" color="#000000" />
                <text
                  className={styles.text}
                  x="510"
                  y="430"
              ...
              <a href="#etniaInfo">
                <path
                  id="CT"
                  d="m936.996 143.345-13.977 5.338-.194-.485-7.862 2.33-1.747.485.194.97 3.688 14.268 1.165 1.456-2.524 3.106 1.748 1.65 5.63-5.435 3.008-4.174.583 1.165 14.17-6.31.292-.29-.097-2.33-.583-2.038-3.008-8.445-.389-1.067-.097-.194z"
                  data-id="CT"
              ...
              <a href="#etniaInfo">
                <path
                  id="NH"
                  d="m923.893 75.983-1.262 1.553-1.456-.291-.777 6.406v.097l2.33 8.735-.194 1.748-4.174 5.532 1.068 5.047v6.31l-.777 5.823 4.368 15.919L927 131.6l12.23-4.077 5.532-6.018v-1.553l.291-2.523-.679.29-.097-.582-6.115-7.473-.194-.68-14.074-33.001z"
                  data-id="NH"
              ...
              <a href="#etniaInfo">
                <path
                  id="RI"
                  d="m946.508 152.08-.097-2.038-.29.776.387 1.262zm1.942-1.553-1.262-2.426-.097 2.523 1.359-.097zm-.583-3.009.68 1.747.873 1.553.583-1.164-.874-1.65-.291-1.165h-.97v.68zm-10.774-3.98.389 1.068 3.009 8.445.582 2.038.097 2.33.194-.291 4.66-3.689-.874-6.6 1.94-.388-4.27-5.145-4.465 1.747-1.262.486z"
                  data-id="RI"
              ...
              <a href="#etniaInfo">
                <path
                  id="VT"
                  d="m923.02 132.862-4.369-15.919.777-5.823v-6.31l-1.068-5.047 4.174-5.532.194-1.748-2.33-8.735-1.261.485-5.339 1.941-5.241 2.039-12.036 4.368-.68.194 4.368 10.191 1.456 9.61 5.145 8.056 4.853 15.918.194-.097.776-.291 2.233-.68 1.941-.68 5.533-1.65.68-.29z"
                  data-id="VT"
                  data-name="Vermont"
                  style={{
                    strokeWidth: 0.97063118,
              ...
              >
                ...
                />
                <MdLocationOn x="740" y="365" color="#000000" />
                <text
                  className={styles.text}
                  x="725"
                  y="395"
              ...
              >
                <path
                  id="GA"
                  d="m845.854 396.097-.097-2.912-.68 2.524.777.388zm1.068-4.465-.389-2.232-.29 1.358.679.874zm-45.426-61.15-1.262.291-3.688.777-13.589 2.815-1.262.29-1.359.195-7.57 1.456-2.039.388-8.25 1.553-1.747.194.097.195 13.006 39.601 7.183 12.813-1.747 1.94-1.068 7.572 2.135 3.882.195 7.086 2.62 4.95v.097l-.097.097 3.3 5.145 45.814-5.727 1.359 3.494 1.456-7.474 2.62-2.038 6.698.388-.582-10.483 1.261-2.232-.68-4.174 1.36-3.98 2.038-2.232-1.456-1.359 3.397-4.173h-.097l-5.823-5.436-7.96-11.356-4.367-2.039-18.734-15.724-4.562-5.824-8.832-3.688-.486-1.941 2.718-5.339z"
                  data-id="GA"
                  data-name="Georgia"
                  style={{
                    strokeWidth: 0.97063118,
                ...
                />
                <MdLocationOn x="790" y="355" color="#000000" />
                <text
                  className={styles.text}
                  x="785"
                  y="385"
              ...
              >
                ...
                />
                <MdLocationOn x="680" y="375" color="#000000" />
                <MdLocationOn x="690" y="375" color="#bd4af3" />
                <text
                  className={styles.text}
                  x="675"
                  y="405"
              ...
              >
                <path
                  id="SC"
                  d="m801.496 330.482-2.718 5.339.486 1.941 8.832 3.688 4.562 5.824 18.734 15.724 4.367 2.039 7.96 11.356 5.823 5.436.971-4.465-1.553-4.271 4.174 3.106 2.33-1.844-3.98-3.3 4.853-.292 7.57-6.406-.873-1.65 4.66-3.591-.486-1.747 3.397-2.136.194-4.95 5.339-9.9 3.591-4.562.388-.194-21.645-13.686-8.056 1.553-10.968-.389-5.436-2.814-32.225 10.191h-.29z"
                  data-id="SC"
                ...
                />
                <MdLocationOn x="835" y="350" color="#000000" />
                <text
                  className={styles.text}
                  x="815"
                  y="345"
              ...
              <a title="Indiana" href="https://callbwa.com/" target="_blank">
                <path
                  id="IN"
                  d="m750.344 200.224-14.85 2.62-3.398.68-12.036 1.94-2.523 2.04-3.786 1.746-1.456-.097-1.747-.873-.582-.583 6.794 47.852-1.359 5.145 2.427 4.562.776 3.785-3.688 8.639-2.136 1.553-.097 8.638.389.098.388-.098 1.456-2.717h3.591l4.368-1.456 5.435 2.038.583-2.232 3.106-2.33 4.659.68 2.524-4.95 6.891.582-.097-2.815 6.115-8.056-.97-3.689 4.27-.097 5.241-4.174-1.261-4.756.194-.194-.194-1.65-5.824-34.36-2.62-14.657-.292-1.553-.291-1.262z"
                  data-id="IN"
                  data-name="Indiana"
                  style={{
                    strokeWidth: 0.97063118,
                ...
                />
                <MdLocationOn x="725" y="220" color="#000000" />
                <text
                  className={styles.text}
                  x="716"
                  y="250"
              ...
              <a title="Kentucky" href="https://callbwa.com/" target="_blank">
                <path
                  id="KY"
                ...
                />
                <MdLocationOn x="760" y="265" color="#000000" />
                <text
                  className={styles.text}
                  x="735"
                  y="293"
              ...
              >
                ...
                />
                <MdLocationOn x="860" y="285" color="#000000" />
                <text
                  className={styles.text}
                  x="830"
                  y="310"
              ...
              >
                ...
                />
                <MdLocationOn x="775" y="210" color="#000000" />
                <text
                  className={styles.text}
                  x="765"
                  y="235"
              ...
              >
                ...
                />
                <MdLocationOn x="750" y="310" color="#000000" />
                <MdLocationOn x="740" y="310" color="#bd4af3" />
                <text
                  className={styles.text}
                  x="710"
                  y="335"
              ...
              <a href="#etniaInfo">
                <path
                  id="DE"
                  d="m893.803 207.697.388 1.456 8.057 23.004 9.22-2.717-.096-.195h.194l.29.098.195-.098-.194-.388-2.33-6.212-11.356-10.774.485-7.474h-2.33l-1.746 1.36-.777 1.94z"
                  data-id="DE"
                  data-name="Delaware"
                  style={{
                    strokeWidth: 0.97063118,
              ...
              <a href="#etniaInfo">
                <path
                  id="DC"
                  d="m878.176 229.148.485.389.194.097.195-.097.194.097.68.388.193.291v.68l.194.388 1.262-2.33-1.359-.776-1.65.097-.388.776z"
                  data-id="DC"
              ...
              >
                <path
                  id="PA"
                  d="m900.015 170.134-6.309-2.718-1.068-2.426-5.435-4.174-29.701 8.93-29.508 8.056-5.144-1.262-.68-2.912-1.65 1.262-2.62 1.844-4.756 4.853-.583.486 2.718 11.938.485 2.136 2.427 10.483.485 2.038 4.271 18.442 13.783-3.397 1.941-.486 1.747-.485 6.892-1.844 37.952-10.58 6.891-2.135 1.65-.486.777-1.94 1.747-1.36h2.33l.29-.873 3.786-4.271.388-.68.291-.194-3.785-9.9-1.844-.291.097-6.504-1.747-2.135 4.076-9.027-.194-.388z"
                  data-id="PA"
                ...
                />
                <MdLocationOn x="850" y="170" color="#000000" />
                <text
                  className={styles.text}
                  x="820"
                  y="200"
              ...
              <a title="Michigan" href="https://callbwa.com/" target="_blank">
                ...
                />
                <MdLocationOn x="735" y="145" color="#000000" />
                <text
                  className={styles.text}
                  x="723"
                  y="175"
              ...
              >
                ...
                />
                <MdLocationOn x="210" y="470" color="#000000" />
                <text
                  className={styles.text}
                  x="200"
                  y="500"
          ...
          <section className={styles.aboutContainer__table}>
            <article className={styles.aboutContainer__table__module}>
              ...
              <br />
              <p>866-457-9227, Ext 0</p>
              <br />
              <br />
              <ul className={styles.brandList}>
                <li className={styles.ulGreen}>GA - GEORGIA</li>
                <br />
                <li className={styles.ulGreen}>AL - ALABAMA</li>
                <br />
                <li className={styles.ulGreen}>MS - MISSISSIPPI</li>
                <br />
                <li className={styles.ulGreen}>TN - TENNESSEE</li>
                <br />
                <li className={styles.ulGreen}>NC - N. CAROLINA</li>
                <br />
                <li className={styles.ulGreen}>SC - S. CAROLINA</li>
              </ul>
            </article>
            <article className={styles.aboutContainer__table__module}>
              <h3>GOLDSMITH</h3>
              ...
              <br />
              <ul className={styles.brandList}>
                <li className={styles.ulOrange}>WA - WASHINGTON</li>
                <br />
                <li className={styles.ulOrange}>OR - OREGON</li>
                <br />
                <li className={styles.ulOrange}>ID - IDAHO</li>
                <br />
                <li className={styles.ulOrange}>MT - MONTANA</li>
                <br />
                <li className={styles.ulOrange}>AK - ALASKA</li>
              </ul>
            </article>
            <article className={styles.aboutContainer__table__module}>
              <h4>LVX</h4>
              ...
              <br />
              <ul className={styles.brandList}>
                <li className={styles.ulBlue}>CA - CALIFORNIA</li>
                <br />
                <li className={styles.ulBlue}>NV - NEVADA</li>
                <br />
                <li className={styles.ulBlue}>HI - HAWAII</li>
                <br />
                <li className={styles.ulBlue}>AZ - ARIZONA</li>
                <br />
                <li className={styles.ulBlue}>NM - NEW MEXICO</li>
                <br />
                <li className={styles.ulBlue}>CO - COLORADO</li>
                <br />
                <li className={styles.ulBlue}>UT - UTAH</li>
                <br />
                <li className={styles.ulBlue}>WY - WYOMING</li>
                <br />
                <li className={styles.ulBlue}>TX - TEXAS</li>
              </ul>
            </article>
            <article className={styles.aboutContainer__table__module}>
              <h5>AUDIO MARKETING</h5>
              <br />
              <p></p>
              <br />
              <p>Doug@ampnation.org</p>
              <br />
              <p></p>
              <br />
              <br />
              <ul className={styles.brandList}>
                <li className={styles.ulGrey}>MO - MISSOURI</li>
                <br />
                <li className={styles.ulGrey}>KS - KANSAS</li>
                <br />
                <li className={styles.ulGrey}>IA - IOWA</li>
                <br />
                <li className={styles.ulGrey}>NE - NEBRASKA</li>
              </ul>
            </article>
            <article className={styles.aboutContainer__table__module}>
              <h6>METRO JOE</h6>
              ...
              <br />
              <ul className={styles.brandList}>
                <li className={styles.ulViolet}>OK - OKLAHOMA</li>
                <br />
                <li className={styles.ulViolet}>AR - ARKANSAS</li>
                <br />
                <li className={styles.ulViolet}>EAST TN - EAST TENNESSEE</li>
                <br />
                <li className={styles.ulViolet}>SW MS - SW MISSISSIPPI</li>
                <br />
                <li className={styles.ulViolet}>LA - LOUISANA</li>
              </ul>
            </article>
            <article className={styles.aboutContainer__table__module}>
              ...
              <br />
              <ul className={styles.brandList}>
                <li className={styles.ulBrown}>MI - MICHIGAN</li>
                <br />
                <li className={styles.ulBrown}>IN - INDIANA</li>
                <br />
                <li className={styles.ulBrown}>OH - OHIO</li>
                <br />
                <li className={styles.ulBrown}>KY - KENTUCKY</li>
                <br />
                <li className={styles.ulBrown}>PA - WESTERN PENNSYLVANIA</li>
              </ul>
            </article>
          </section>
          <br />
          <section className={styles.aboutContainer__infoInter}>
            <div className={styles.aboutDivition}></div>
            <section className={styles.aboutContainer__infoInter__title}>
              <article>
                <h2>/ INTERNATIONAL SALES /</h2>
              </article>
            </section>
            <section className={styles.internationalSales}>
              <div className={styles.internationalSales__edg}>
                <h3>Edgardo Cuerno</h3>
                <br />
                <p></p>
